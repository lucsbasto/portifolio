        ...
        <div className='p-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64  lg:w-2/3 lg:pr-0 xl:1/2'>
          ...
          <div className='flex flex-col gap-12 justify-center'>
            ...
            <p className='text-lg'>
              ...
              Odit ullam, consectetur suscipit autem ut mollitia repudiandae tenetur. 
              Earum ullam, reprehenderit beatae, quo explicabo, nostrum voluptate eligendi id animi itaque unde.
            </p>
            {/* BIOGRAPHY QUOTE */}
            ...
            <div>
              ...
              <div className='flex justify-between h-48'>
                ...
                <div className='w-1/3'>
                  ...
                  {/* company name  */}
                  <div className='p-1 rounded bg-white text-sm font-semibold w-fit'>Raiô</div>
                </div>
                {/* center  */}
                <div className='w-1/6'>
                  {/* LINE  */}
                  ...
                  {/* CIRCLE  */}
                  <div className='absolute h-5 w-5 rounded-full ring-4 ring-red-400 bg-white -left-2'>
                  </div>
                </div>
                </div>
